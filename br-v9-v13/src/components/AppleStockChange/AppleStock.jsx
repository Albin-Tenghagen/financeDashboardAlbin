...
const AppleStock = () => {
  ...
  // // Dispatch the stock price change fetch when the symbolInput changes
  // useEffect(() => {
  //   if (symbolInput) {
  //     console.log("Fetching stock price for symbol:", symbolInput);
  //     dispatch(fetchStockPriceChange(symbolInput));
  //   }
  // }, [symbolInput]);
